...
public class Locations implements Map<Integer, Location> {
    ...
    public static void main(String[] args) throws IOException {
        try (RandomAccessFile rao = new RandomAccessFile("location_rand.dat","rwd")) {
            ...
            System.out.println("[[RAO GET FILE POINTER]] :: " + rao.getFilePointer());
            System.out.println("[[INDEX SIZE]] :: " + locations.size() * 3 * Integer.BYTES);
            ...
            for(Integer locationID : index.keySet()) {
                ...
                System.out.println("[[INDEX GET START BYTE]] :: " + index.get(locationID).getStartByte());
                rao.writeInt(index.get(locationID).getStartByte());
                System.out.println("[[INDEX GET LENGTH]] :: " + index.get(locationID).getLength());
