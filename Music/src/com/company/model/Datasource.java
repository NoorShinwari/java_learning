...
public class Datasource {
    ...
    public boolean open() {
        try {
            ...
            queryAlbum = connection.prepareStatement(QUERY_ALBUMS);
            return true;
...
//            sb.append(" COLLATE NOCASE ");
    ...
    public void querySongsMetadata() {
        ...
        try (Statement statement = connection.createStatement();
            ...
            System.out.println("Error in execution query metadata: " + e.getMessage());
        }
    }
    ...
    public int getCount(String table) {
        ...
        try (Statement statement = connection.createStatement();
            ...
            System.out.println("Error execution Query Count: " + e.getMessage());
            return -1;
        }
    }
    ...
    public boolean createViewForSongsArtists() {
        try (Statement statement = connection.createStatement()
            ...
            System.out.println("QUERY: " + CREATE_ARTIST_FOR_SONG_VIEW);
            return true;
        } catch (SQLException e) {
    ...
    public void insertSong(String title, String artist, String album, int track)  {
        ...
        try {
            ...
            if (affectedRows == 1) {
                ...
                throw new SQLException("The song is not inserted!");
            }
            ...
            try {
                ...
                System.out.println("Error Resetting commit behavior to default..." + e.getMessage());
            }
        }
    }
}
